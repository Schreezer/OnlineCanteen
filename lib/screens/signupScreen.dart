...
import "package:online_canteen/main.dart";
...
import "package:online_canteen/utils/widgets.dart";
import "package:online_canteen/widgets/textFieldInput.dart";
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<String> Next() async {
    ...
    try {
      // TODO: implement signupUser function in AuthMethods
      ...
      child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Bio TextField
              TextFieldInput(
                hintText: "Entry Number (Optional))",
                textInputType: TextInputType.text,
                textEditingController: _entryNumberController,
              ),
              const SizedBox(height: 20),
              // Email TextField
              TextFieldInput(
